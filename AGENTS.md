...
```bash
./run.sh paper2org <URL> [--name NAME] [--fetch]   # → out/anthropic-paper/<name>/<name>.org
# 예: ./run.sh paper2org https://transformer-circuits.pub/2026/workspace/index.html --name jspace --fetch
```
