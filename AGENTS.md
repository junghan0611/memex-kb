...
**web HTML**(`paper2org-html`, ox-html+oc-basic=인용/수식 렌더, `scripts/paper_html_build.el`, texlive 불필요).
J-space 검증: PDF 93쪽·인용 155개 bibtex 해석 / HTML raw `[cite:` 0·참고문헌 목록·MathJax. (docx=pandoc 은 후속 — NEXT 참조.)
