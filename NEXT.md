...
### 다음 한 걸음 — 물리학강의 봉합 적용(감독, 새 세션)

- [ ] **물리학강의** → 그림 200+·수식 多. para-splits 701(page 392/image 130/eq 58/table 17/samepage 104).
      ⚠️ image/table_interrupt 보류분 많음 + **평문 강표지(4·13·18강) 가드 확인** + samepage 책별 판단(dry-run 통독).
...
- [x] **scanbook SKILL.md에 "samepage_break는 책별 판단" 환류 완료** — §Reliability tiers에 samepage_break를 PER-BOOK decision으로 분리, page_boundary-only 결정 규칙 추가(2026-06-04).
