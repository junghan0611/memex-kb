...
| Anthropic Distill HTML papers | Active | `scripts/anthropic_paper_to_org.py`, `./run.sh paper2org` / `paper2org-pdf` / `paper2org-html` | Org (math/figure/citation-aware) → ArXiv-style acmart PDF + ox-html HTML |
