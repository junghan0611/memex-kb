...
;; 헤딩 자동 장번호 끔 — 양식은 수동 번호(1. / 3-1.)를 텍스트로 직접 사용.
;; (켜두면 LibreOffice 렌더 시 "1. 1." 처럼 자동+수동 번호가 중복됨)
(setq org-export-with-section-numbers nil)

;; 캡션 장번호 연동 끔 — "표 3.1.1" → "표 1" 단순 연번.
;; (sequence-decl display-outline-level 을 0 으로: 그림/표 캡션에서 장.절 prefix 제거)
